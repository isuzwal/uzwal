...
export const Works: WorksProps[] = [
  {
    ...
    descrption_1: `
     Focused on designing and developing clean, scalable, and user-friendly interfaces that enhance the overall user experience. 
    ...
    descrption_2: `
       ...
       I actively optimized performance by improving load times, reducing unnecessary re-renders, and following best practices for modern frontend development
        `,
    descrption_3: `
        Implemented robust backend API integrations to fetch and update data securely, ensuring seamless communication between frontend and backend services.
        `,
    tech: [
      {
        name: 'Next.js',
      ...
      },
      {
        ...
        icon: (
          <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 256 256">
            ...
            <path d="M128 56l80 144H48z" fill="#fff" />
          </svg>
        ),
      },
    ],
...
export const InterTeachnologies: TechnologiesProps[] = [
  {
    name: 'Next.js',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24">
