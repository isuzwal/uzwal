      ...
      <div className=" flex flex-col   w-full  px-0 py-0 ">
        ...
        <div className="border w-full  py-2 ">
          <p className="text-start items-center dark:text-neutral-400 text-neutral-600 font-semibold font-mono text-sm p-2">
            ...
            <span className="inline-flex items-center text-sm bg-black/5 dark:bg-white/15 border border-dashed dark:border-white/30 border-black/20 py-1 px-2 rounded-md skill-inner-shadow self-end text-black dark:text-white gap-1">
            ...
            ,
            <span className="inline-flex items-center text-sm bg-black/5 dark:bg-white/15 border border-dashed dark:border-white/30 border-black/20 py-1 px-2 rounded-md skill-inner-shadow self-end text-black dark:text-white gap-2">
        ...
        <div className="border-b w-full  py-0.5">
